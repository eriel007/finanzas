  ...
  useEffect(() => {
    ...
    const initData = async () => {
      try {
        ...
        const existingCats = cats.filter((c) => c.type === "EXPENSE");
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#060608] flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md px-6 py-12" style={{ animation: 'fadeInUp 0.8s ease-out' }}>
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-white tracking-tight">New Expense</h1>
            <p className="text-sm text-neutral-500">Register a new expense transaction</p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-neutral-700/50 bg-neutral-800/50 px-4 py-3 text-sm text-white focus:border-red-500/50 focus:outline-none focus:ring-1 focus:ring-red-500/20 transition-all duration-300 appearance-none"
                  required
                >
              ...
              {success && (
                <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
                  <p className="text-sm text-emerald-400">Expense registered successfully!</p>
                </div>
              )}
