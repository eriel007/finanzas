    ...
    <main className="relative min-h-screen overflow-hidden bg-[#060608] flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md px-6 py-12" style={{ animation: 'fadeInUp 0.8s ease-out' }}>
        <div className="flex items-center gap-4 mb-8">
          <Link href="/account/income" className="w-10 h-10 rounded-xl border border-neutral-800/50 bg-neutral-900/60 backdrop-blur-sm flex items-center justify-center hover:border-emerald-500/30 transition-colors">
            <svg className="w-4 h-4 text-neutral-400" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clipRule="evenodd" />
            </svg>
          </Link>
          <div>
            <h1 className="text-2xl font-semibold text-white tracking-tight">Edit Income</h1>
            <p className="text-sm text-neutral-500">Update income transaction</p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div className="space-y-2">
                ...
                <select id="account" value={accountId} onChange={(e) => setAccountId(e.target.value)}
                  className="w-full rounded-xl border border-neutral-700/50 bg-neutral-800/50 px-4 py-3 text-sm text-white focus:border-emerald-500/50 focus:outline-none focus:ring-1 focus:ring-emerald-500/20 transition-all duration-300 appearance-none" required>
              ...
              {success && (
                <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4">
                  <p className="text-sm text-emerald-400">Income updated successfully!</p>
                </div>
              )}
